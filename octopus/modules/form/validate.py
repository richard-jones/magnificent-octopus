...
class ExclusiveCheckbox(object):
    ...
    def __init__(self, exclusive_checkbox_value=None, message='When you have selected "{exclusive_checkbox_value}" you are not allowed to tick any other checkboxes.', *args, **kwargs):
